...
class OrderController extends Controller
{
    ...
    public function merchantIndex(Request $request, Merchant $merchant)
    {
        ...
        if ($merchant->segmentation_id === 3) {
            return app(\App\Http\Controllers\ServiceOrderController::class)->getMerchantOrders($request, $merchant);
        }
    ...
    public function merchantShow(Merchant $merchant, Order $order)
    {
        ...
        if ($merchant->segmentation_id === 3) {
            return app(\App\Http\Controllers\ServiceOrderController::class)->getMerchantOrderDetail(request(), $merchant, $order->id);
        }
    ...
    {
        if ($merchant->segmentation_id === 3) {
            return app(\App\Http\Controllers\ServiceOrderController::class)->updateStatus($request, $merchant, $order->id);
        }
