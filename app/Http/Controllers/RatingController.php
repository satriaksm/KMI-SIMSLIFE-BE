...
class RatingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'product_order_item_id' => 'nullable|integer',
        ...
        $productOrderItemId = $data['product_order_item_id'] ?? null;
        ...
        if ($data['rateable_type'] === 'App\\Models\\Product') {
            ...
            if ($productOrderItemId !== null) {
                ...
                $productItem = ProductOrderItem::where('id', $productOrderItemId)
            ...
            $existingRating = Rating::where('product_order_item_id', $productOrderItemId)
                ->exists();
        } else {
            if ($productOrderItemId !== null) {
                return response()->json(['message' => 'product_order_item_id harus null untuk rating jasa'], 422);
            }
        ...
        // Tambahkan user_id, product_order_item_id, dan jasa_order_item_id
        $data['user_id'] = $user->id;
        $data['product_order_item_id'] = $productOrderItemId;
